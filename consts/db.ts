...
export const DB:Project[] = [
  ...
  },
  {
    ...
    description: {
      [Lang.Es]: 'Desarrollo de una plataforma para la gestión de Licitaciones de Suministros Eléctricos otorgando las mejores ofertas para los usuarios libres.',
      [Lang.En]: 'Development of a platform for the management of Electrical Supply Tenders granting the best offers for free users.'
    },
  ...
  },
  {
    ...
    description: {
      [Lang.Es]: 'Aplicativo mobile para la búsqueda de soporte técnico para empresas',
      [Lang.En]: 'Mobile application to search for technical support for companies'
    },
    techs: 'React Native, Reactjs, React Native Maps, Redux, Async Storage, React Navigation',
