    ...
    <footer className="p-4 bg-gray-900 dark:bg-black flex flex-col items-center text-gray-200 ">
      <nav className="w-full sm:w-40 2xl:w-80">
        <ul className="flex justify-around sm:justify-between text-base lg-text-lg xl:text-xl 2xl:text-2xl ">
          <li>
            <a
              className="hover:text-purple-500 transition-all duration-300 ease-out"
              target="_blank"
              href="https://github.com/mjfura"
              rel="noreferrer"
            >
              <FiGithub />
            </a>
          ...
          <li>
            <a
              ...
              target="_blank"
              href="https://www.linkedin.com/in/marco-josu%C3%A9-fura-mendoza-270a30212/"
              rel="noreferrer"
            >
              <FiLinkedin />
            </a>
      ...
      <h1 className="text-sm sm:text-base 2xl:text-xl">
        © Copyright 2022, All rights reserved.
      </h1>
      <p className="text-sm sm:text-base 2xl:text-xl">
        Developed by Marco Fura
      </p>
    </footer>
  )
}
