...
export default function BurgerButton(){
    ...
    return(
        <button onClick={toggleNav} className="flex items-center" >
            <span className={`
            block relative 
            ...
            after:block after:transition-all after:duration-500 after:absolute after:w-full after:h-full after:content-[' '] after:bg-gray-800 after:-bottom-2 after:rounded-lg transition-all duration-500 ${nav.active?"-translate-x-4 -rotate-90 before:-rotate-[60deg] before:translate-y-6 before:translate-x-2 after:translate-y-2 after:-translate-x-2 after:rotate-[60deg] ":" "} bg-gray-800 w-8 h-1 rounded-lg
            `} ></span>
        </button>
    )
}