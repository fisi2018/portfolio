...
export default function Home(){
    ...
    return(
        ...
        <section className="min-h-screen flex flex-col dark:text-white items-center justify-center " >
            <h1 className={`text-4xl sm:text-5xl  md:text-6xl  xl:text-7xl 2xl:text-9xl transition-all duration-500 mb-4 ${mounted?"tracking-widest ":" tracking-tighter "}`} >Marco Fura</h1>
            <h2 className="xl:text-3xl lg:text-2xl py-2 2xl:text-5xl text-base sm:text-lg w-[32ch] whitespace-nowrap text-center block border-r-[0.125rem] md:border-r-2 border-transparent 
            ...
            <h3 className="xl:text-xl 2xl:text-3xl lg:text-lg w-[31ch] whitespace-nowrap text-sm text-center block border-r-[0.125rem] md:border-r-2 border-transparent 
