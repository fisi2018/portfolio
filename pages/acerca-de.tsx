  ...
  return (
        <Layout>
            ...
            <section className="min-h-screen flex justify-center items-center p-4 z-30" >
                <p className=" w-full sm:w-96 md:w-[40rem] text-base text-center sm:text-xl md:text-2xl 2xl:text-3xl dark:text-white " >{state.content.pages.about.title} </p>
            </section>
            <section block-scroll="block-scroll" className="min-h-screen mt-4 dark:text-white transition-all duration-1000 opacity-0 p-4 flex items-center flex-col 2xl:justify-around lg:flex-row z-30 " >
                <div className="sm:p-4" >
                <h2 className="sm:text-5xl md:text-6xl 2xl:text-7xl text-4xl text-center lg:text-left tracking-wider  " >{state.content.pages.about.skills.subtitle}</h2>
            ...
            <section block-scroll="block-scroll" className="min-h-screen dark:text-white transition-all duration-1000 opacity-0 flex flex-col items-center lg:flex-row-reverse lg:justify-around  p-4 z-30 " >
                <div className="sm:p-4" >
                    <h2 className="text-4xl sm:text-5xl text-center lg:text-left 2xl:text-7xl xl:text-6xl " >{state.content.pages.about.experience.subtitle}</h2>
            ...
            <section className="min-h-screen relative p-4 z-30 flex flex-col dark:text-white items-center" >
                ...
                <h2 className="text-2xl 2xl:text-4xl text-center sm:text-3xl" >{state.content.pages.about.prysmo.subtitle}</h2>
                ...
                <p className=" w-full sm:w-96 xl:w-96 sm:text-base text-sm 2xl:text-xl text-center" >{state.content.pages.about.prysmo.description}</p>
                ...
                after:block after:transition-all after:ease-out after:duration-500 hover:after:w-[105%] hover:after:h-[115%] hover:after:border-2 after:w-1/2 after:h-1/2 after:border-b-2 after:border-r-2 after:absolute after:bottom-0 after:right-0 after:border-gray-800 dark:after:border-white " rel="noreferrer" >
